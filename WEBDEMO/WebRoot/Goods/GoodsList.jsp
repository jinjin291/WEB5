                    ...
                    <div class="portlet-body">
                        <div class="clearfix">
                            ...
                            <div class="btn-group">
                              ...
                              <div class="btn-group">
                                <a id="delete" type="button" class="btn green">删除商品 <i class="icon-edit"></i>
                                </a>
                            </div>  
            ...
            success: function (result) {            	
                if (result.code == 1) {
                    ...
                    for (var i = 0; i < data.length; i++) {     
                        ...
                        html += '<td class="hidden-480">' + StandardTime(data[i].CSTARTIME) + '</td>';
                        html += '<td class="hidden-480">' + data[i].CIMAGE + '</td>';
                        html += '<td class="hidden-480"><a href="./com.Manager.Communication/EditContact?CID=' + data[i].CID + '&active=menupage6_6" class="label label-important" style="color: white;">编辑</a></td></tr>';
